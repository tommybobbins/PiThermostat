...
def crankers_upcoming(request,calendar_slug):
#     upcoming_events = get_object_or_404(Event, calendar_id=1)
     upcoming_events = Event.objects.all()
     return render(request, 'schedule/upcoming.html', { 'upcoming': Event.objects.all()})
