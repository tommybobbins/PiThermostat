...
class Socket(models.Model):
    ...
    switch_state = models.BooleanField(help_text='On is Checked, Off is Unchecked')
...
class Boiler(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Boiler"

class SocketAdmin(admin.ModelAdmin):
    list_display = ('name','plug_id','set_id','switch_state')

class BoilerAdmin(admin.ModelAdmin):
    list_display = ('name','switch_state')
